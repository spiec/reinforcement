...
# ----------------------------------------------------------------------
class PongAgent(DqnAgent):

    def __init__(self, state_size, n_actions, filename=None):
        super(PongAgent, self).__init__(state_size, n_actions, memory_size=250000,
                                        architecture=PongNet)
        self.batch_size = 32 
        self.discount = 0.95
    ...
    def episode_finished(self, episode_idx, n_episodes):
        ...
        super(PongAgent, self).episode_finished(episode_idx, n_episodes)
